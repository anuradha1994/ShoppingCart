			...
			<div class="container">
					<div class="header-top-in">
						...
						<!-- <ul class=" support-right">
							<li><a href="login"><i class="glyphicon glyphicon-user" class="men"> </i>Login</a></li>
				...
				<form:form action="Register" method="post"
                   commandName="usersDetail">
					...
					<div>
						...
						<form:input type="text" path="userFullName" id="fullname" required="required"/> 
					</div>
					<div>
						<span>Last Name</span>
						<form:input type="text" path="username" id="lastname" required="required"/> 
						 
					 </div>
					 <div>
						 <span>Email Address</span>
						 <form:input type="text" path="userEmail" id="email" required="required"/>
						 </div>
						 <div>
							<span>Password</span>
								<form:input type="text" path="password" id="pwd" required="required"/>						 
					</div>
					 </div>
